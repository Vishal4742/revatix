...
import { getConnectedAccount } from '../utils/algorand';
  ...
  const handleApprove = async () => {
    ...
    try {
      ...
      if (!walletAddress) {
        ...
        setQrValue(`revatix://vat-refund/${Date.now()}`);
      } else {
        // Use the connected wallet address
        setQrValue(`revatix://vat-refund/${walletAddress}/${Date.now()}`);
      }
      setStep('sign');
    } catch (error) {
        ...
        return (
          <div className="space-y-4">
            <div className="bg-gray-100 border border-gray-200 rounded-lg p-4 flex flex-col items-center justify-center">
              ...
              <p className="text-sm text-gray-700 mb-3">Scan with EVM Wallet to sign</p>
              ...
              <p className="text-xs text-gray-500 mt-3">
                Open your EVM wallet app and scan this QR code to sign the transaction
              </p>
            </div>
            <button
              onClick={handleSign}
