...
function AlgopayLandingPage({ isWalletConnected = false, onNavigateToDashboard }: AlgopayLandingPageProps) {
  return (
    <div className="flex h-full w-full flex-col items-start bg-default-background">
      ...
      <div id="home" className="flex w-full flex-col items-center justify-center gap-12 b px-6 py-32 pt-40 relative overflow-hidden">
        ...
        <div className="flex w-full flex-col items-center justify-center gap-8 z-10">
          <div className="inline-block px-4 py-2 bg-brand-50 rounded-full mb-2">
            <span className="font-['Montserrat'] text-[14px] font-[700] text-brand-800">BUILT ON YELLOW NETWORK</span>
          </div>
          <span className="w-full max-w-[1024px] whitespace-pre-wrap font-['Montserrat'] text-[96px] font-[900] leading-[84px] text-brand-800 text-center -tracking-[0.04em] mobile:font-['Montserrat'] mobile:text-[52px] mobile:font-[900] mobile:leading-[68px] mobile:tracking-normal">
            {"Gasless Global Remittance"} <br /> <span className="bg-gradient-to-r from-brand-800 to-brand-600 bg-clip-text text-transparent">Infrastructure</span>
          </span>
          ...
          <span className="w-full max-w-[768px] whitespace-pre-wrap font-['Montserrat'] text-[22px] font-[600] leading-[32px] text-brand-800 text-center -tracking-[0.015em]">
            {
              "Gasless borderless payments infrastructure built on Yellow Network with ERC-7824 state channels unifying VAT refunds and global payroll automation. Zero fees, instant finality, and AI-driven financial intelligence."
            }
          </span>
        </div>
          ...
          {!isWalletConnected ? (
            ...
            <>
              <Button
                ...
                icon={<ArrowRight size={20} />}
                className="px-8 py-6 hover:bg-brand-700 transition-all duration-300"
              >
                Go to Dashboard
              </Button>
              <Button
        ...
        <div className="flex flex-wrap justify-center gap-12 mt-12 z-10 w-full max-w-[1024px]">
          <div className="flex flex-col items-center">
            <span className="font-['Montserrat'] text-[36px] font-[900] text-brand-800">Instant</span>
            <span className="font-['Montserrat'] text-[14px] font-[600] text-brand-600">State Channel Finality</span>
          </div>
          <div className="flex flex-col items-center">
        ...
        <div className="w-full max-w-[1280px] grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 flex flex-col gap-6">
            ...
            <p className="text-subtext-color font-['Montserrat'] text-[16px] leading-[24px]">
              Built on Yellow Network with ERC-7824 state channels providing instant finality, minimal fees, and scalable off-chain transactions with on-chain dispute resolution.
            </p>
            <div className="flex flex-wrap gap-2 mt-auto">
              <span className="px-3 py-1 bg-brand-50 rounded-full text-sm font-medium text-brand-800">Instant Finality</span>
              <span className="px-3 py-1 bg-brand-50 rounded-full text-sm font-medium text-brand-800">Minimal Fees</span>
              <span className="px-3 py-1 bg-brand-50 rounded-full text-sm font-medium text-brand-800">Multi-Chain Support</span>
            </div>
            <div className="flex items-center gap-4 mt-4">
              <div className="w-8 h-8 rounded-full bg-yellow-500 flex items-center justify-center">
                <span className="text-white font-bold text-sm">Y</span>
              </div>
              <span className="font-['Montserrat'] text-[14px] font-[500] leading-[20px] text-default-font">Yellow Network</span>
              <div className="w-8 h-8 rounded-full bg-blue-500 flex items-center justify-center">
                <span className="text-white font-bold text-xs">E</span>
              </div>
              <span className="font-['Montserrat'] text-[14px] font-[500] leading-[20px] text-default-font">ERC-7824</span>
            </div>
          </div>
        ...
        <div className="w-full max-w-[1280px] flex flex-col gap-12">
              ...
              <div className="absolute inset-0 bg-gradient-to-r from-brand-900/70 to-transparent flex items-center justify-center p-8">
                <div className="text-white max-w-[400px]">
                  ...
                  <p className="font-['Montserrat'] text-[16px] leading-[24px] mb-6">
                    Revatix's infrastructure eliminates geographical barriers, enabling instant cross-border transactions with state channels and minimal fees.
                  </p>
            ...
            <div className="flex-1 flex flex-col items-start justify-center gap-8 p-12">
              <div className="flex flex-col items-start justify-center gap-6">
                ...
                <span className="whitespace-pre-wrap font-['Montserrat'] text-[18px] font-[400] leading-[26px] text-subtext-color -tracking-[0.01em]">
                  {
                    "Revatix unifies VAT refunds for tourists and global payroll automation on a single trustless platform. Powered by Yellow Network's state channels for instant finality and AI-driven compliance."
                  }
                </span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-brand-50 rounded-2xl p-8 flex flex-col items-center text-center">
              ...
              <p className="text-subtext-color mt-2">100% of transactions complete instantly with Yellow Network's state channels</p>
            </div>
      ...
      <div id="benefits-section" className="flex w-full flex-col items-center justify-center gap-16 bg-neutral-100 px-6 py-32 relative overflow-hidden">
        ...
        <div className="flex w-full max-w-[1280px] flex-col items-center gap-6 z-10">
          <span className="inline-block px-4 py-1 bg-brand-50 rounded-full">
            <span className="font-['Montserrat'] text-[12px] font-[700] text-brand-800">WHY REVATIX</span>
          </span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300 group">
              ...
              <div className="p-8">
                <div className="flex items-center gap-2 mb-4">
                  <span className="px-3 py-1 bg-brand-50 rounded-full text-sm font-medium text-brand-800">INSTANT</span>
                  <span className="px-3 py-1 bg-green-50 rounded-full text-sm font-medium text-green-700">100% SUCCESS RATE</span>
                </div>
                ...
                <p className="text-subtext-color font-['Montserrat'] text-[16px] leading-[24px] mb-6">
                  Experience instant finality for VAT refunds and payroll transactions with Yellow Network's state channel technology.
                </p>
            ...
            <div className="bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300 group">
              ...
              <div className="p-8">
                ...
                <p className="text-subtext-color font-['Montserrat'] text-[16px] leading-[24px] mb-6">
                  Microtransactions become feasible for VAT refunds with minimal fees through state channels, saving up to 95% compared to traditional banking.
                </p>
                <ul className="space-y-3">
                  <li className="flex items-start gap-2">
                    <div className="w-5 h-5 rounded-full bg-green-50 flex items-center justify-center mt-1">
      ...
      <div className="flex w-full flex-col items-center justify-center gap-16 bg-default-background px-6 py-32">
        <div className="flex w-full max-w-[1280px] flex-col items-center gap-6">
          ...
          <p className="max-w-[768px] text-center text-subtext-color font-['Montserrat'] text-[18px] leading-[28px]">
            Revatix combines VAT refunds for tourists and global payroll automation into a single borderless payments infrastructure with Yellow Network state channels and AI-driven intelligence
          </p>
        </div>
            ...
            <div className="md:w-1/2 bg-brand-900 p-12 relative">
              ...
              <div className="relative z-10">
                ...
                <p className="text-white/90 font-['Montserrat'] text-[18px] leading-[28px] mb-8">
                  Streamline VAT refunds for tourists leaving Dubai and other jurisdictions, solving delays, missed claims, and inefficiencies in reclaiming tax with instant state channel payouts.
                </p>

                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                  <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4">
                    <h3 className="font-['Montserrat'] text-[18px] font-[700] text-white mb-2">Tourist Experience</h3>
                    <p className="text-white/80 text-sm">Tourists scan their VAT tag at airport kiosks and receive refunds directly to their wallet instantly via state channels</p>
                  </div>
                ...
                <div className="space-y-6">
                  <div className="flex gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-subtext-color">Retailer issues invoice + tax-free tag. Tourist wallet connects to Revatix's state channel network.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-subtext-color">Tourist scans tag at kiosk. Operator system validates goods exported and pushes a signed webhook to Revatix Oracle.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-subtext-color">Tourist receives USDC or YELLOW via state channel with instant finality.</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-auto">
                <div className="bg-neutral-50 rounded-xl p-6 border border-neutral-100">
                  ...
                  <p className="text-subtext-color mb-4">
                    A Japanese tourist purchases a luxury watch in Dubai Mall for AED 50,000 (incl. 5% VAT = AED 2,500). Using Revatix, they scan the VAT tag at Dubai Airport and receive AED 2,125 (85% of VAT) in USDC directly to their wallet instantly via state channels.
                  </p>
                  <div className="flex items-center gap-2">
                    <span className="px-3 py-1 bg-green-50 rounded-full text-xs font-medium text-green-700">INSTANT PAYOUT</span>
          ...
          <div className="flex flex-col md:flex-row-reverse bg-white rounded-3xl overflow-hidden shadow-xl">
            <div className="md:w-1/2 bg-brand-800 p-12 relative">
              ...
              <div className="relative z-10">
                ...
                <p className="text-white/90 font-['Montserrat'] text-[18px] leading-[28px] mb-8">
                  Automate payroll for distributed teams across jurisdictions, reducing transaction fees, ensuring compliance, and enabling instant state channel salary payouts.
                </p>
            ...
            <div className="md:w-1/2 p-8 md:p-12 flex flex-col">
                ...
                <div className="space-y-6">
                  <div className="flex gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-subtext-color">HR uploads CSV/contracts. AI parses gross salary, deductions, tax rules by jurisdiction and produces structured state channel transaction plan.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-subtext-color">CFO/HR dual-approves the payrun. Planner chunks recipients into state channel groups and treasury key signs for broadcast.</p>
                    </div>
                  </div>
              ...
              <div className="mt-auto">
                <div className="bg-neutral-50 rounded-xl p-6 border border-neutral-100">
                  <h4 className="font-['Montserrat'] text-[16px] font-[700] text-default-font mb-2">Real-World Example</h4>
                  <p className="text-subtext-color mb-4">
                    A tech startup with 50 employees across 12 countries processes their monthly payroll of $250,000. Using Revatix, they save $11,250 in fees (vs. traditional banking), ensure tax compliance across all jurisdictions, and complete all payments instantly via state channels.
                  </p>
                  <div className="flex items-center gap-2">
      ...
      <div id="about-section" className="flex w-full flex-col items-center justify-center gap-16 bg-neutral-100 px-6 py-32 relative overflow-hidden">
        ...
        <div className="flex w-full max-w-[1280px] flex-col items-center gap-6 z-10">
          ...
          <span className="w-full max-w-[768px] font-['Montserrat'] text-[48px] font-[800] leading-[52px] text-default-font text-center -tracking-[0.02em]">
            Dual Workflows with Revatix
          </span>
          <p className="max-w-[768px] text-center text-subtext-color font-['Montserrat'] text-[18px] leading-[28px]">
            Our platform handles both VAT refunds and global payroll with streamlined, automated processes built on Yellow Network's state channels
          </p>
        </div>
                      ...
                      <div className="flex-1 bg-neutral-50 rounded-xl p-6 border border-neutral-100 shadow-sm">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                          <div className="col-span-2">
                            <p className="text-subtext-color mb-4">
                              When a tourist makes a purchase at a participating retailer, the store issues both a standard invoice and a special tax-free tag. The tourist's wallet then connects to Revatix's state channel network, opening a claim box keyed by a unique claim_id.
                            </p>
                    ...
                    <div className="flex gap-8">
                      ...
                      <div className="flex-1 bg-neutral-50 rounded-xl p-6 border border-neutral-100 shadow-sm">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                          <div className="col-span-2">
                            <p className="text-subtext-color mb-4">
                              Once validated, the state channel computes the refund amount (VAT * rate - fee) and the tourist receives USDC or YELLOW via state channel transfer. The treasury disburses funds in grouped transactions with instant finality, ensuring the tourist receives their refund before boarding their flight.
                            </p>
                            <div className="flex flex-wrap gap-3">
                              <span className="px-3 py-1 bg-brand-50 rounded-full text-xs font-medium text-brand-800">STATE CHANNELS</span>
                              <span className="px-3 py-1 bg-brand-50 rounded-full text-xs font-medium text-brand-800">INSTANT FINALITY</span>
                          ...
                          <div className="bg-white rounded-lg p-4 shadow-inner border border-neutral-100">
                            ...
                            <ul className="space-y-2 text-sm text-subtext-color">
                              ...
                              <li>• Choice of USDC or YELLOW</li>
                    ...
                    <div className="flex gap-8">
                      ...
                      <div className="flex-1 bg-neutral-50 rounded-xl p-6 border border-neutral-100 shadow-sm">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                          <div className="col-span-2">
                            <p className="text-subtext-color mb-4">
                              The HR department uploads payroll data in CSV format or through contracts into the Revatix dashboard. The AI layer parses the gross salary, deductions, and tax rules by jurisdiction, then produces a structured state channel transaction plan with net salaries, assets (USDC/YELLOW), and any necessary FX conversions.
                            </p>
                            <div className="flex flex-wrap gap-3">
                    ...
                    <div className="flex gap-8">
                      ...
                      <div className="flex-1 bg-neutral-50 rounded-xl p-6 border border-neutral-100 shadow-sm">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                          <div className="col-span-2">
                            <p className="text-subtext-color mb-4">
                              The CFO and HR department must both approve the payrun to ensure security and accuracy. Once approved, a payrun_id snapshot is stored in both Supabase and the Yellow Network state channel system as an immutable reference. The planner then chunks recipients into state channel groups for efficient processing.
                            </p>
                            <div className="flex flex-wrap gap-3">
                              <span className="px-3 py-1 bg-brand-50 rounded-full text-xs font-medium text-brand-800">DUAL APPROVAL</span>
                              <span className="px-3 py-1 bg-brand-50 rounded-full text-xs font-medium text-brand-800">STATE CHANNEL GROUPS</span>
      ...
      <div className="flex w-full flex-col items-center justify-center gap-12 bg-default-background px-6 py-32">
        <div className="flex w-full max-w-[1024px] flex-col items-center justify-center gap-8">
          <span className="w-full whitespace-pre-wrap font-['Montserrat'] text-[62px] font-[900] leading-[58px] text-brand-900 text-center -tracking-[0.04em] mobile:font-['Montserrat'] mobile:text-[40px] mobile:font-[900] mobile:leading-[40px] mobile:tracking-normal">
            {" CHOOSE REVATIX FOR BORDERLESS PAYMENTS"}
          </span>
          <span className="max-w-[768px] whitespace-pre-wrap font-['Montserrat'] text-[20px] font-[400] leading-[28px] text-default-font text-center -tracking-[0.015em]">
            {
              "Combining Yellow Network state channels with AI-driven financial intelligence for VAT refunds and global payroll on a single trustless platform."
            }
          </span>
        </div>
            ...
            <div className="flex w-full flex-col items-start gap-6">
              <div className="flex flex-col items-start gap-2">
                ...
                <span className="font-['Montserrat'] text-[18px] font-[400] leading-[26px] text-subtext-color -tracking-[0.01em]">
                  Perfect for small teams getting started with state channel payroll
                </span>
              </div>
        ...
        <div className="flex w-full flex-col items-center justify-center gap-6">
            ...
            <div className="flex min-h-[384px] min-w-[240px] max-w-[384px] grow shrink-0 basis-0 flex-col items-start justify-end gap-8 self-stretch rounded-[32px] bg-default-background px-8 py-8 mobile:min-h-[384px] mobile:w-full mobile:min-w-[240px] mobile:grow mobile:shrink-0 mobile:basis-0">
              <div className="flex w-full flex-col items-start justify-center gap-4">
                ...
                <span className="w-full max-w-[576px] whitespace-pre-wrap font-['Montserrat'] text-[18px] font-[400] leading-[26px] text-default-font -tracking-[0.01em]">
                  {
                    "Get the latest updates and news from our state channel payroll platform.\n"
                  }
                </span>
              </div>
            </div>
          ...
          <div className="flex w-full max-w-[1280px] flex-wrap items-center justify-center gap-6 mobile:flex-col mobile:flex-wrap mobile:gap-6">
            <div className="flex min-h-[384px] min-w-[240px] max-w-[384px] grow shrink-0 basis-0 flex-col items-start justify-end gap-8 self-stretch rounded-[32px] bg-default-background px-8 py-8 mobile:min-h-[384px] mobile:w-full mobile:min-w-[240px] mobile:grow mobile:shrink-0 mobile:basis-0">
              <div className="flex w-full flex-col items-start justify-center gap-4">
                <span className="max-w-[384px] whitespace-pre-wrap font-['Montserrat'] text-[30px] font-[700] leading-[34px] text-brand-900 -tracking-[0.025em]">
                  {"The trusted payroll system on Yellow Network"}
                </span>
                <span className="w-full max-w-[576px] whitespace-pre-wrap font-['Montserrat'] text-[18px] font-[400] leading-[26px] text-default-font -tracking-[0.01em]">
                  {
                    "Experience the ease with payment on Yellow Network state channels for your global payroll solution.\n"
                  }
                </span>
              </div>
            </div>
        ...
        <div className="flex w-full max-w-[1280px] flex-col items-center justify-center gap-8 rounded-[32px] bg-default-background px-6 pt-24 pb-16 shadow-2xl relative z-10">
          ...
          <div className="flex w-full flex-col items-center justify-center gap-6">
            ...
            <span className="w-full max-w-[768px] whitespace-pre-wrap font-['Montserrat'] text-[20px] font-[500] leading-[28px] text-brand-900 text-center -tracking-[0.015em]">
              {
                "Join the next-generation remittance infrastructure — instant, borderless, compliant, and scalable for both VAT refunds and global payroll with Yellow Network state channels."
              }
            </span>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full mt-8 mb-12">
              <div className="bg-neutral-50 rounded-xl p-6 flex flex-col items-center text-center">
                ...
                <p className="text-subtext-color text-sm">Instant transactions with state channel finality</p>
              </div>
          ...
          <div className="flex flex-col md:flex-row gap-6 items-center">
            ...
            <Button
              size="large"
              variant="neutral-secondary"
              onClick={() => window.open('https://docs.revatix.com', '_blank')}
              icon={<ArrowRight size={20} />}
