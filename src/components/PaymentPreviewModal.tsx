...
import { sendBulkPayment, formatAddress } from '../utils/algorand';
...
export const PaymentPreviewModal: React.FC<PaymentPreviewModalProps> = ({
  ...
  // Wallet connection status is now passed as props
    ...
    try {
      ...
      if (error instanceof Error) {
        if (error.message.includes('asset') && error.message.includes('missing from')) {
          ...
          errorMessage = `Recipient ${shortAddress} has not opted-in to receive USDC. They must opt-in before receiving USDC payments. Ask them to opt-in first, or switch to YELLOW payments.`;
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div>
              ...
              <div className="bg-gray-50 border border-gray-200 rounded-lg p-6 space-y-4">
                ...
                {/* Network Fees - Yellow Network is Gasless */}
                <div className="flex items-center justify-between">
                  <span className="text-gray-600">Network Fees:</span>
                  <span className="font-medium text-green-600">Gasless (Yellow Network)</span>
                </div>
                ...
                <div className="border-t border-gray-200 pt-4">
                  <div className="flex items-center justify-between text-lg">
                    ...
                    <div className="text-right">
                      ...
                      <div className="text-sm text-green-600">+ Gasless (Yellow Network)</div>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-green-50 border border-green-200 rounded-lg p-3 mt-4">
                  ...
                  <div className="text-xs text-green-700">
                    All payments are processed on Yellow Network with state channel security.
                  </div>
                </div>
              </div>
            </div>
