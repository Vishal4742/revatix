...
const synonyms: Synonym = {
  ...
  'market cap': ['market capitalization', 'mcap', 'marketcap', 'cap', 'market size'],
...
export const detectIntent = (text: string): {
  ...
  const intents = {
    ...
    'blockchain_query': ['blockchain', 'algorand', 'crypto', 'consensus', 'transaction', 'fees'],
...
export const smartTextProcessing = (text: string): {
  originalText: string;
